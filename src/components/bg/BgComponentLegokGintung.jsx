...
import foto1 from './../../assets/img25.jpg';
import foto2 from './../../assets/img26.jpg';
import foto3 from './../../assets/img27.jpg';
import foto4 from './../../assets/img28.jpg';
import foto5 from './../../assets/img29.jpg';
...
const BgComponentLegokGintung = () => {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden mb-10">
      ...
      <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 flex space-x-2 z-30rounded-xl">
        {images.map((_, index) => (
          <button
            key={index}
...
export default BgComponentLegokGintung;
