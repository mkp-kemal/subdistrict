...
import logo from './../assets/logo_nagrak2.png';
...
const NavbarComponent = () => {
  ...
  const navOrder = ["home", "profile", "maintenance", "activity", "apbd", "history", "jdih", "community"];
    ...
    <nav className={`bg-tosca shadow-lg fixed w-full top-0 z-50 font-inherit transition-transform duration-300 ease-in-out ${hideOnScroll ? 'transform -translate-y-full' : ''}`}>
      ...
      <div className="container mx-auto flex items-center justify-between p-4">
        <div className="flex items-center">
          <img src={logo} alt="Logo Desa Nagrak Subang" className="h-11 w-11" />
        ...
        <div className="lg:hidden">
          ...
          <div className={`absolute right-0 top-full w-full bg-white border-t-2 border-tosca rounded-b-lg transition-all duration-300 ease-in-out ${isOpen ? 'max-h-screen opacity-100' : ' hidden max-h-0 opacity-0'}`}>
